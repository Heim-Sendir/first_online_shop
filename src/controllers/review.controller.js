...
var addReview = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, user, product, create_time, rating, comment, newReview, saveReview, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, user = _a.user, product = _a.product, create_time = _a.create_time, rating = _a.rating, comment = _a.comment;
                newReview = new review_model_1.Review({
                    user: user,
                    product: product,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, review_model_1.Review.findByIdAndDelete(id)];
            case 1:
                _a.sent();
