...
exports.deleteCategory = exports.getCategoryById = exports.getAllCategory = exports.createCategory = void 0;
...
var createCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, description, active, create_time, newCategory, saveCategory, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name_1 = _a.name, description = _a.description, active = _a.active, create_time = _a.create_time;
                newCategory = new category_model_1.Category({
                    name: name_1,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, category_model_1.Category.findById(id)];
            case 1:
                category = _a.sent();
                if (!category) {
                    return [2 /*return*/, res.status(404).json({ error: 'Категория не найдена' })];
                }
                res.json(category);
                return [3 /*break*/, 3];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, category_model_1.Category.findByIdAndDelete(id)];
            case 1:
                _a.sent();
